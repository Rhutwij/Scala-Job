...
class DataRegistrySpec extends FunSpec with BeforeAndAfter with SharedSparkContext {
  ...
  //  {
  //    val mailImpressionPaths: Seq[String] = DataRegistry.datePaths(14, "/home/wenjing/Downloads/spark-seed/src/test/resources/fixtures/", "sample_mail_update.log", new LocalDate(2015, 7, 8))
  //    if (mailImpressionPaths.isEmpty)
  //    {
  //      println("Files do not exist, cannot read files")
  //    }
  //    else{
  //      val MailDataFrame = DataRegistry.loadDataFrames(mailImpressionPaths)
